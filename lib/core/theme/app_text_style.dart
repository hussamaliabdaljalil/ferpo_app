...
class AppTextStyle {
  ...
  static const TextStyle f16W400HintTextColor = TextStyle(
      fontWeight: FontWeight.w400, fontSize: 16, color: AppColors.primaryColor);

  static const TextStyle f16W500White =
      TextStyle(fontWeight: FontWeight.w500, fontSize: 16, color: Colors.white);

  ///// Font Size 32
  static const TextStyle f32W700Black = TextStyle(
      fontWeight: FontWeight.w700, fontSize: 32, color: AppColors.primaryColor);
}
